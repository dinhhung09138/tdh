    ...
    table = $('#tbList').DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                width: '210px',
                render: function (obj, type, data, meta) {
                    return '<img src="' + data.Image + '" width="200" height="100" />';
                }
            },
            {
                data: 'Title',
            ...
            },
            {
                ...
                searchable: false,
                render: function (obj, type, data, meta) {
                    return '<h3 style="color:red; font-size: 15px;">' + data.Heading + '</h3><p style="color: purple; font-size: 13px;">' + data.DiscountHeading + '</p>';
                }
            },
            {
                orderable: false,
                ...
                render: function (obj, type, data, meta) {
                    if (data.Link !== "") {
                        return '<a href="' + data.Link + '" target="_blank">Xem</a>';
                    }
                    return "";
                }
            },
            ...
            },
            {
                ...
                render: function (obj, type, data, meta) {
                    var str = '';
                    if (allowEdit === "True") {
                        str = str + '<a href="/administrator/admsetting/editbanner/' + data.ID + '\" title="Cập nhật"><i class="fa fa-edit" aria-hidden="true"></i></a>';
                    }
                    if (allowDelete === "True") {
...
function savePublish(id, publish) {
    $.ajax({
        url: '/administrator/admsetting/publishbanner',
        type: 'POST',
...
function deleteItem() {
    $.ajax({
        url: '/administrator/admsetting/deletebanner',
        type: 'POST',
        contentType: 'application/json',
        dataType: 'json',
