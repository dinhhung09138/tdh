    ...
    table = $('#tbList').DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                searchable: true,
                render: function (obj, type, data, meta) {
                    return '<a href="/administrator/admtarget/detailidea/' + data.ID + '\">' + data.Title + '</a>';
                }
            },
            {
                data: 'Count',
            ...
            },
            {
                ...
                render: function (obj, type, data, meta) {
                    var str = '';
                    if (allowEdit === "True") {
                        str = str + '<a href="/administrator/admtarget/editidea/' + data.ID + '\" title="Cập nhật"><i class="fa fa-edit" aria-hidden="true"></i></a>';
                    }
                    if (allowDelete === "True") {
