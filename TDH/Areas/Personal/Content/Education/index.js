...
$(document).ready(function () {
    ...
    table = $('#tbList').DataTable({
        ...
        language: language,
        ajax: {
            url: '/personal/pneducation/index',
            type: 'post',
            data: function (d) {
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (obj, type, data, meta) {
                    var str = '';
                    if (allowEdit === "True") {
                        str = str + '<a href="/personal/pneducation/edit/' + data.ID + '\" title="Cập nhật thông tin đào tạo" class="mg-lr-2"><i class="fa fa-edit" aria-hidden="true"></i></a>';
                    }
                    if (allowDelete === "True") {
...
function deleteItem() {
    $.ajax({
        url: '/personal/pneducation/delete',
        type: 'POST',
